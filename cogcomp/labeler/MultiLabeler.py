...
class labelRecord_result(object):
  """
  Attributes:
   - success
   - ex
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(cogcomp.base.ttypes.Labeling, cogcomp.base.ttypes.Labeling.thrift_spec)), None, ), # 0
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            _elem5 = cogcomp.base.ttypes.Labeling()
            _elem5.read(iprot)
