...
class Record(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.rawText = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.rawText is not None:
      ...
      oprot.writeString(self.rawText.encode('utf-8'))
      oprot.writeFieldEnd()
    ...
    if self.views is not None:
      ...
      for kiter34,viter35 in self.views.items():
        oprot.writeString(kiter34.encode('utf-8'))
        viter35.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i67 in xrange(_size63):
            _key68 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.records is not None:
      ...
      for iter70 in self.records:
        oprot.writeString(iter70.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.labelViews is not None:
      oprot.writeFieldBegin('labelViews', TType.MAP, 3)
    ...
    if self.parseViews is not None:
      ...
      for kiter75,viter76 in self.parseViews.items():
        oprot.writeString(kiter75.encode('utf-8'))
        viter76.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.views is not None:
      ...
      for kiter77,viter78 in self.views.items():
        oprot.writeString(kiter77.encode('utf-8'))
        viter78.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
