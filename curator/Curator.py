...
class describeAnnotations_args(object):
...
class describeAnnotations_result(object):
  """
  Attributes:
   - success
  """
      ...
      if fid == 0:
        if ftype == TType.MAP:
          ...
          for _i83 in xrange(_size79):
            _key84 = iprot.readString().decode('utf-8')
            _val85 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter86,viter87 in self.success.items():
        ...
        oprot.writeString(viter87.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class isCacheAvailable_args(object):
...
class isCacheAvailable_result(object):
  """
  Attributes:
   - success
  """
...
class provide_args(object):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.view_name = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.view_name is not None:
      ...
      oprot.writeString(self.view_name.encode('utf-8'))
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i92 in xrange(_size88):
            _elem93 = iprot.readString().decode('utf-8')
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i99 in xrange(_size95):
            _elem100 = iprot.readString().decode('utf-8')
...
class wsgetRecord_result(object):
  """
  Attributes:
   - success
   - ex
...
class getRecordById_args(object):
  """
  Attributes:
   - identifier
  """
...
class getRecordById_result(object):
  """
  Attributes:
   - success
   - ex
...
class storeRecord_result(object):
  """
  Attributes:
   - ssex
  """
...
class getMultiRecord_args(object):
  """
  Attributes:
   - texts
  """
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i106 in xrange(_size102):
            _elem107 = iprot.readString().decode('utf-8')
...
class getMultiRecord_result(object):
  """
  Attributes:
   - success
   - ex
...
class provideMulti_args(object):
  """
  Attributes:
   - view_name
   - texts
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i113 in xrange(_size109):
            _elem114 = iprot.readString().decode('utf-8')
...
class provideMulti_result(object):
  """
  Attributes:
   - success
   - suex
...
class storeMultiRecord_args(object):
  """
  Attributes:
   - record
  """
...
class storeMultiRecord_result(object):
  """
  Attributes:
   - ssex
  """
